...
class CreateMaterialPageContentInformation extends StatefulWidget {
  Function onDateChanged;
  Function onNotesChanged;
  MaterialDetailResponse? materialDetailResponse;

  @override
  _CreateMaterialPageContentInformationState createState() =>
      _CreateMaterialPageContentInformationState();

  CreateMaterialPageContentInformation(
      {Key? key,
      required this.onDateChanged,
      required this.onNotesChanged,
      this.materialDetailResponse})
      : super(key: key);
}

class _CreateMaterialPageContentInformationState
    extends State<CreateMaterialPageContentInformation>
    with AutomaticKeepAliveClientMixin<CreateMaterialPageContentInformation> {
  ...
  void processEditPage() {
    MaterialDetailResponse? materialDetailResponse =
        widget.materialDetailResponse;
    if (materialDetailResponse != null) {
      _dateController.text =
          TimeUtils.toServerDateTime(materialDetailResponse.date);
      _noteController.text = materialDetailResponse.notes ?? "";
    }
  }
